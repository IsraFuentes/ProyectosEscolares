 ...
 * @author Isra fuentes
 */
public final class  ConexionLdap {
   ...
   /**
     ...
     *
     */
public ConexionLdap(String server, String dn, String ta,String usuario,String clave) {
    ...
    public Attribute cargarPropiedadConexion(String atributo) {
        ...
        System.out.println("comenzando try ..");
        try {
            Attributes attrs = dc.getAttributes(dn);
            System.out.println("dc.atributos : " +attrs);
 
            if (attrs == null) {
                propiedad = null;
                System.out.println("propiedad null");
            } else {
                System.out.println("propiedad = attrs.get(atributo) :" +propiedad);
                propiedad = attrs.get(atributo);
            }
        } catch (Exception e) {
            propiedad = null;
            System.out.println("catch : propiedad null");
        }
        return propiedad;
    }
